...
contract BlockReward is EternalStorage {
    ...
    bytes32
        internal constant EXTRA_RECEIVERS_LENGTH = 0x0678259008a66390de8a5ac3f500d1dfb0d0f57018441e2cc69aaa0f52c97d44; // keccak256(abi.encodePacked("extraReceiversLength"))
    bytes32
        internal constant EXTRA_RECEIVER_ADDRESS = 0xa47da669ec9f3749fbb12db00588b5fa6b5bbd24da81eb6cab44261334c21c17; // keccak256(abi.encodePacked("extraReceiverAddress"))
    bytes32
        internal constant EXTRA_RECEIVER_AMOUNT = 0x0f09dbb26898a3af738d25c5fff308337ac8f2b0acbbaf209b373fb1389bcf2f; // keccak256(abi.encodePacked("extraReceiverAmount"))
    ...
    bytes32
        internal constant MINTED_FOR_ACCOUNT_IN_BLOCK = 0x24ae442c1f305c4f1294bf2dddd491a64250b2818b446706e9a74aeaaaf6f419; // keccak256(abi.encodePacked("mintedForAccountInBlock"))
    ...
    bytes32
        internal constant MINTED_TOTALLY_BY_BRIDGE = 0x12e71282a577e2b463da2c18bc96b6122db29bcef9065ed5a7f0f9316c11c08e; // keccak256(abi.encodePacked("mintedTotallyByBridge"))

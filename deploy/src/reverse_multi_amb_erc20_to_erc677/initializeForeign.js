...
const {
  foreignContracts: { EternalStorageProxy, HomeMultiAMBErc20ToErc677: ForeignBridge }
...
async function initialize({ homeBridge, foreignBridge, foreignTokenImage }) {

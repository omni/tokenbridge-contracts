  ...
  describe('handleBridgedTokens', () => {
    ...
    it('should mint tokens on message from amb', async () => {
      ...
      await ambBridgeContract
        .executeMessageCall(homeBridge.address, owner, data, exampleTxHash)
        .should.be.rejectedWith(ERROR_MSG)

      await ambBridgeContract.executeMessageCall(homeBridge.address, mediatorContract.address, data, exampleTxHash)
        .should.be.fulfilled

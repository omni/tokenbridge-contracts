...
const ForeignBridgeErcToNativeWithCompoundMock = artifacts.require('ForeignBridgeErcToNativeWithCompoundMock.sol')
...
contract('ForeignBridge_ERC20_to_Native', async accounts => {
  ...
  describe('compound connector', () => {
    ...
    beforeEach(async () => {
      foreignBridge = await ForeignBridgeErcToNativeWithCompoundMock.new()
      await foreignBridge.initialize(
        validatorContract.address,
        dai.address,
        requireBlockConfirmations,

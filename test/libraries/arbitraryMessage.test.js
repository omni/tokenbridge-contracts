...
contract('ArbitraryMessage.sol', async () => {
  describe('unpackData', () => {
    it('unpack dataType 0x00', async () => {
      ...
      const msgChainId = '11223344556677889900aabbccddeeff11223344556677889900aabbccddeeff'
      ...
      const message =
        `${msgId}${msgChainId}003667154bb32e42bb9e1e6532f19d187fa0082e` + // sender
      ...
      // then
      const { messageId, chainId, sender, executor, gasLimit, dataType, gasPrice, data } = result
      expect(messageId).to.be.equal(msgId)
      expect(chainId.toString(16)).to.be.equal(msgChainId)
    ...
    it('unpack dataType 0x01', async () => {
      ...
      const message =
        `${msgId}${msgChainId}c95e32f5b21aea8107aa2c645636e909489031e8` + // sender
        'f4bef13f9f4f2b203faf0c3cbbaabe1afe056955' + // contractAddress
        '5b877705' + // gasLimit
        '01' + // dataType
    ...
    it('unpack dataType 0x02', async () => {
      ...
      const message =
        `${msgId}${msgChainId}e0241f385c58c88911531ddfe3b5f0fc729bdaee` + // sender
        'f4bef13f9f4f2b203faf0c3cbbaabe1afe056955' + // contractAddress
        '5b877705' + // gasLimit
        '02' + // dataType
